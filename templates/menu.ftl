    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>">Miguel BASIRE</a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="http://twitter.com/MiguelBasire"><i class="fa fa-twitter"></i></a></li>
            <li class="dropdown">
